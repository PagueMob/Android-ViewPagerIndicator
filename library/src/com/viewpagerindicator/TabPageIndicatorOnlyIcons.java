 ...
 */
public class TabPageIndicatorOnlyIcons extends HorizontalScrollView implements
		PageIndicator {
	...
	public TabPageIndicatorOnlyIcons(Context context) {
		this(context, null);
	}

	public TabPageIndicatorOnlyIcons(Context context, AttributeSet attrs) {
		super(context, attrs);
